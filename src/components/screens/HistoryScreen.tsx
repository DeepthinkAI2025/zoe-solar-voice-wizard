...
const HistoryScreen: React.FC<HistoryScreenProps> = ({ onCallSelect, onStartCall, onStartCallManually, onSelectContact }) => {
  return (
    <CallScreen title="Anrufliste">
      {callHistory.map((call, i) => {
        const isKnownContact = call.name !== 'Unbekannter Anrufer' && call.number !== 'Unbekannt';
        return (
